...
export default function Hero() {
  return (
    <section className="relative h-[85vh] w-full overflow-hidden bg-black lg:h-screen">
      <picture>
        <source media="(min-width: 1024px)" srcSet="/backdasktop1.png" />
        <img
          src="/backmob2.png"
          alt="JF Baterias - Entrega e instalação de baterias automotivas em Vespasiano"
          fetchPriority="high"
          decoding="async"
      ...
      <div className="relative z-10 flex flex-col gap-3 px-5 pt-8 lg:h-full lg:max-w-2xl lg:justify-center lg:gap-6 lg:px-16 lg:pt-0">
        ...
        <h1 className="text-4xl font-extrabold leading-[1.05] tracking-tight text-white drop-shadow-lg lg:text-6xl">
          Bateria arriou?{" "}
          <span className="text-white  px-2 py-0.5 rounded-lg inline-block">
            A gente leva e instala pra você.
          </span>
        </h1>

        <p className="max-w-[20rem] text-sm leading-relaxed text-zinc-100 drop-shadow-md lg:max-w-lg lg:text-lg">
          Moura, Heliar, Zetta e as melhores marcas. Testamos sua bateria e alternador na hora, com garantia de fábrica.
        </p>

        <div className="flex items-center gap-2 text-sm font-semibold text-[#0530A1] bg-white/90 w-fit px-3 py-1 rounded-full shadow-sm lg:text-base">
          <svg
            className="h-5 w-5"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <div className="flex flex-col gap-2.5 pt-1 lg:flex-row lg:gap-4 lg:pt-2">
          <WhatsAppLink className="flex h-13 items-center justify-center gap-2 rounded-full bg-[#25D366] text-base font-bold text-white shadow-lg shadow-black/30 active:scale-[0.98] lg:w-auto lg:px-8">
