          ...
          >
            ...
            <div className="mt-6 pt-3 border-t border-zinc-100">
              <a
                ...
                className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-zinc-900 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-black active:scale-[0.98]"
              >
