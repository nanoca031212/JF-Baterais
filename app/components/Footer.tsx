      ...
      <div className="lg:mx-auto lg:grid lg:max-w-6xl lg:grid-cols-[1.3fr_1fr_1fr] lg:gap-12">
        <div>
          ...
          <a
            ...
            className="mt-6 flex h-13 w-full items-center justify-center gap-2 rounded-full bg-[#25D366] text-base font-bold text-white active:scale-[0.98] lg:w-fit lg:px-8"
          >
