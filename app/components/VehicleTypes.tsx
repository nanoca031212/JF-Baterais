          ...
          {VEHICLES.map((vehicle) => (
            <AnimatedHighlightCard key={vehicle.label}>
              <a
                ...
                className="group relative block h-[340px] w-full overflow-hidden rounded-[2rem] bg-zinc-100 shadow-md transition-all duration-300 active:scale-[0.98] hover:shadow-xl lg:h-[380px]"
              >
                <Image
                  src={vehicle.image}
