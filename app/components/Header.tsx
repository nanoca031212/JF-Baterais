...
export default function Header() {
  return (
    <header className="flex items-center justify-between border-b border-zinc-100 bg-white px-5 py-3 lg:px-12 lg:py-4">
      <Image
        src="/Logo.webp"
        alt="Rufino Baterias"
        width={1024}
      ...
      <a
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] lg:h-11 lg:w-11"
      >
