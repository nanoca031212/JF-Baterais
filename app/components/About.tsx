    ...
    >
      <div className="lg:mx-auto lg:grid lg:max-w-6xl lg:grid-cols-2 lg:items-center lg:gap-16">
        ...
        <div className="lg:order-1">
          ...
          <div className="mt-7">
            <WhatsAppLink className="inline-flex h-13 w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-8 text-base font-bold text-white shadow-md active:scale-[0.98] transition hover:bg-[#20bd5a] lg:w-fit">
